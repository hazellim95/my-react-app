...
const getToken = async code => {
    ...
    const codeVerifierFinal = localStorage.getItem('code_verifier');
    ...
    const payload = {
        ...
        code,
        redirect_uri: redirectUri,
        code_verifier: codeVerifierFinal,
        }),
    }
    ...
    return (
        <>
            <div>
                ...
                />
                <div>
                    <button id="authButton" onClick={handleAuth}>Get Authorisation</button>
                    <button id="searchButton" onClick={handleClick}>Search</button>
                </div>
            </div>
            <SearchResults receivedText={userInput} receivedData={data} loading={loading} error={error} authError={authError}/>
        </>
    )
}
